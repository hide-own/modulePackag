<template>
  <div class="pb-4">
    <div
      @click="toggle"
      :class="value ? 'bg-sky-900 bg-opacity-75' : 'bg-gray-400'"
      ...
      <span :class="['absolute top-0.5 text-sm text-white',value?'left-3':'right-3']">{{ value ? checked : unchecked }}</span>
      <span
        aria-hidden="true"
        :class="value ? 'translate-x-9' : 'translate-x-0'"
