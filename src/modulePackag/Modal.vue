<template>
  <div class="fixed inset-0" v-if="visible">
    <div class="relative h-[100vh] inset-0 z-10">
      <transition
        ...
        leave-to="opacity-0">
        <div @click="closeModal" class="fixed inset-0 bg-black bg-opacity-25"/>
      </transition>
      ...
      <div
        ...
        <transition
          ...
          <div
            ...
            <div class="flex justify-around py-3 text-center" v-if="!footer">
              <button
                type="button"
