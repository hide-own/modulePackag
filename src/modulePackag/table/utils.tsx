...
export function createTableExtension<Config>(ext: UserTableExtension<Config>): TableExtension<Config> {
...
export function createUserDraggable(config: true | UserTableDraggable): UserTableExtension<TableDraggableConfig> {
  return createBuiltinExtension(config, {
    ...
    cell(row, column): VNodeChild {
      return (
        <button type="button" class="w-4 h-4">#</button>
      );
    },
  });
}

export function createUserExpandable(config: true | UserTableExpandable): UserTableExtension<TableExpandableConfig> {
  return createBuiltinExtension(config, {
    name: "expandable",
    width: 32,
    multi: true,
...
export function createUserSelectable(config: true | UserTableSelectable): UserTableExtension<TableSelectableConfig> {
  return createBuiltinExtension(config, {
    name: "selectable",
    width: 32,
    multi: true,
...
export function createUserActionable(config: true | UserTableActionable): UserTableExtension<TableActionableConfig> {
  return createBuiltinExtension(config, {
    name: "actionable",
    title: '操作',
    // width: 32,
...
export const ExpansionButton = defineComponent({
  ...
  setup(props, {emit, attrs}) {
    return () => {
      let path: string;
      if (props.expanded) path = "M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z";
      else path = "M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z";
      return (
        <button
          type="button"
