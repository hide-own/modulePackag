import {computed, defineComponent, inject, PropType, provide, ref, Slot, toRef, VNodeChild, watch} from "vue";
...
export default defineComponent({
  ...
  emits: {
    ...
    "cell-click": (row: TableRow, rowIndex: number, column: TableColumn | TableExtension, columnIndex: number) => true,
  ...
  setup(props, {emit, slots}): RenderFunction {
    ...
    const extensions = computed(() => {
      ...
      if (props.draggable) list.push(createDraggable(props.draggable));
    ...
    /** 加载和分页 */
    provide(tablePaginationKey, usePagination({
      load: props.loader,
      total: 100,
    }))
    ...
    return (): VNodeChild => {
      return (
        <div class={['relative overflow-x-auto w-full', {
          ...
          <table
            class={['w-full whitespace-nowrap bg-white overflow-hidden', {'divide-y divide-gray-200': props.features?.divide}]}>
